export const coaches = [
  ...
  },
  {
    ...
    name: 'Matt Symonds',
    title: 'Founder',
    credential: 'Global Education Expert | Forbes Columnist',
    photo: '/images/team/matt.jpg',
    schools: [],
    isFeatured: true,
  },
  {
...
export const mbaCoaches = [];
export const lawCoaches = [];
export const collegeCoaches = [];
